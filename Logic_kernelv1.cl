...
__kernel void logicsimulationRobust(
    ...
    __global uint *robust_result2, __global uint *is_robust_path_to_po) {
  ...
  for (int i = 0; i < size; i++) {
           ...
           // gate type can also be used to determine the in_degree
    {
      ...
      //isRobustOrNonRobust_l; 	is_robust_or_non_robust_result2[output_offset +
      //c_node] = isRobustOrNonRobust_2;
